      ...
      <div className="max-w-5xl mx-auto px-6 py-12 
        ...
        <section id="formulas" className="flex flex-col gap-8">
          ...
          <div className="p-6 bg-panel-bg border border-border-subtle 
            ...
            {/* Formula display */}
            <div className="p-4 bg-gray-950 rounded-lg border 
              ...
              <ResponsiveContainer width="100%" height={180}>
                ...
                >
                  <CartesianGrid strokeDasharray="3 3" 
                                 stroke="#1e1e2e" />
                  <XAxis dataKey="eve" stroke="#4b5563"
                    tick={{ fill: '#4b5563', fontSize: 10,
                            fontFamily: 'monospace' }}
                    label={{ value: 'Eve Interception %',
            ...
            <div className="flex flex-col gap-2">
              ...
              <ResponsiveContainer width="100%" height={180}>
                ...
                >
                  <CartesianGrid strokeDasharray="3 3"
                                 stroke="#1e1e2e" />
                  <XAxis dataKey="qber" stroke="#4b5563"
                    tick={{ fill: '#4b5563', fontSize: 10,
                            fontFamily: 'monospace' }}
                    label={{ value: 'QBER %',
                             position: 'insideBottom',
